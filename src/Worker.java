...
public class Worker extends User{
    ...
    public Worker(Integer id, Integer age, String login, String password, String name,
        ...
        super(id, age, login, password, name, surname);     //super - это конструктор родительского класса
        this.salary = salary;
    ...
    public Integer getSalary(){ return salary;}         //функция и метод - это одно и то же
